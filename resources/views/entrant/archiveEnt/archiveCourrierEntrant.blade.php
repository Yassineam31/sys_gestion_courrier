...
<head>
    ...
    <link rel="stylesheet" href="style/archiveCourrierEntrant.css">
    <title>أرشيف البريد الوارد</title>
</head>
<body>
    <!-- Sidebar -->
        ...
        <div class="container">
            ...
            <table class='table table-striped table-hover mt-5'>
                <tr >
                    <td colspan='7' style="background-color: #353b49;height:70px;">
                        <div class="d-flex" style="position:relative;">
                            ...
                            <h4 class='courrier-entrant'>أرشيف البريد الوارد</h4>
                        </div> 
                    </td>
                </tr>
                <tr dir='rtl'>
                ...
                <tr>
                    ...
                    <td>{{$donnee->Statut}}</td>
                    <td>
                        <a href="/modifierArchiveEnt/{{$donnee->id}}" title='تغيير'><i class="fa-solid fa-pen-to-square"></i></a> | <a href="/voirArchiveEnt/{{$donnee->id}}" title='إظهار'> <i class="fa-solid fa-eye"></i></a><br>
                        <button id="openModalBtn{{$donnee->id}}" title='مسح'><i class="fa-solid fa-trash"></i></button>
                    </td>
                </tr>
                <!-- The Modal -->
                <div id="myModal{{$donnee->id}}" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="btn-container">
                            <form method="POST" action="{{ route('supprArchiveEnt', ['id' => $donnee->id]) }}">
                                @csrf
                                @method('DELETE')
                                <button class='btn bg-danger text-white fw-bold' type="submit" >حـــــذف</button>
                            </form>
                            <!-- Button to close the modal -->
                            <a class='btn' style='border:1px solid silver;font-weight:700;' href="/archivesEntrants">رجــــــوع</a>
                        </div>
                    </div>
                </div>
            ...
            @else
            <h2 style='text-align:center;'>لا يوجد أرشيف حاليا</h2>
            @endif
