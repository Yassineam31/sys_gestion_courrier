...
<head>
    ...
    <link rel="stylesheet" href="style/archiveCourrierSortant.css">
    <title>أرشيف البريد الصادر</title>
</head>
<body>
    <!-- Sidebar -->
        ...
        <div class="container">
            ...
            <table class='table table-striped table-hover mt-5'>
                <tr>
                    <td colspan='7' style="background-color: #353b49;height:70px;">
                        <div class="d-flex" style="position:relative;">
                            ...
                            <h4 class='courrier-sortant'>أرشيف البريد الصادر</h4>
                        </div> 
                    </td>
                </tr>
                <tr dir='rtl'>
                ...
                <tr>
                    ...
                    <td>{{$donnee->Statut}}</td>
                    <td>
                        <a href="/voirArchiveSort/{{$donnee->id}}" title='إظهار'> <i class="fa-solid fa-eye"></i></a> | <a href="/modifierArchiveSort/{{$donnee->id}}" title='تغيير'><i class="fa-solid fa-pen-to-square"></i></a><br>
                ...
                <div id="myModal{{$donnee->id}}" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="btn-container">
                            <form method="POST" action="{{ route('supprArchiveSort', ['id' => $donnee->id]) }}">
                                @csrf
                                @method('DELETE')
                                <button class='btn bg-danger text-white fw-bold' type="submit" >حـــــذف</button>
                            </form>
                            <!-- Button to close the modal -->
                            <a class='btn' style='border:1px solid silver;font-weight:700;' href="/archivesSortant">رجــــــوع</a>
                        </div>
                    </div>
                </div>
